...
<?php init_head(); ?>
<link rel="stylesheet" href="<?= module_dir_url('pancake_sync', 'assets/css/orders.css'); ?>?v=<?= time(); ?>">
    ...
    <div class="content">
        <div class="tw-p-4 sm:tw-p-6 lg:tw-p-8">
            <div class="search-filter-container">
                ...
                <!-- TÌM KIẾM THEO SỐ ĐT, TÊN KHÁCH HÀNG -->
            ...
            <!-- JS HIỆN HÀNH ĐỘNG ĐANG ĐỒNG BỘ -->
            ...
            <!-- BẢNG TABLE TẤT CẢ THÔNG TIN ĐƠN HÀNG ĐC LẤY TỪ JSON -->
                                                                    ...
                                                                    <?php foreach ($items as $it): ?>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="tw-px-4 tw-py-3 tw-border tw-border-gray-300 tw-text-center">
                                                                                ...
                                                                                <?php if ($isCombo): ?>
                                                                                    <span class="tw-ml-2 tw-text-xs tw-font-medium tw-bg--100 tw-rounded-full tw-px-2 tw-py-0.5">Combo</span>
                                                                                <?php endif; ?>
                                                                                <?php if ($isGift): ?>
                                                                                    <span></span>
                                                                                <?php endif; ?>
...
<!-- TẤT CẢ SCRIPT CỦA BẢNG VÀ ĐỒNG BỘ -->
<script>
