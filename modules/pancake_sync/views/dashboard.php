...
<?php init_head(); ?>
<link rel="stylesheet" href="<?= module_dir_url('pancake_sync', 'assets/css/pancake_dashboard.css'); ?>?v=<?= time(); ?>">
        ...
        <div class="section">
            ...
            <div class="card pad">
                ...
                <div class="overview" style="margin-top: var(--gap);">
                    <div class="kpi">
                        <h6>Doanh số</h6>
                        <div class="val money"><?= number_format($sales_volume_confirmed ?? 0, 0, ',', '.'); ?></div>
                    </div>
                    <div class="kpi">
                        <h6>Doanh thu</h6>
                        <div class="val money"><?= number_format($revenue_confirmed ?? 0, 0, ',', '.'); ?></div>
                    </div>
                    <div class="kpi">
                        <h6>Số đơn chốt</h6>
                    ...
                    <div class="kpi">
                        <h6>GTTB</h6>
                        <div class="val money"><?= number_format($aov_confirmed ?? 0, 0, ',', '.'); ?></div>
                    </div>
                </div>
                ...
                <div class="overview" style="margin-top: var(--gap);">
                    ...
                    <div class="kpi">
                        ...
                        <div class="val money"><?= number_format($don_hang_huy ?? 0, 0, ',', '.'); ?></div>
                    </div>
                    <div class="kpi">
                        <h6>Tỷ lệ chốt</h6>
